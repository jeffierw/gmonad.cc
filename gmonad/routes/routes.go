...
func SetupRouter(r *gin.Engine) {
	...
	event := r.Group("/v1/events")
	{
		...
		event.POST("/:eventId/recap", middlewares.JWT("blog:write"), controllers.CreateReacp)
		event.DELETE("/:eventId/recap/:id", middlewares.JWT("blog:delete"), controllers.DeleteRecap)
		event.PUT("/:eventId/recap/:id", middlewares.JWT("blog:write"), controllers.UpdateRecap)
		event.GET("/:eventId/recap", controllers.GetRecap)
	}
